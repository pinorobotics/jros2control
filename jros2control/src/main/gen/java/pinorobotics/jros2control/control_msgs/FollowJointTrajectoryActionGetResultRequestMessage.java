...
@MessageMetadata(
        name = FollowJointTrajectoryActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class FollowJointTrajectoryActionGetResultRequestMessage
        implements Action2GetResultRequestMessage {

    static final String NAME = "control_msgs/FollowJointTrajectoryActionGetResult";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    @Override
    public FollowJointTrajectoryActionGetResultRequestMessage withGoalId(
