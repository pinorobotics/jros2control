...
@MessageMetadata(
        name = ParallelGripperCommandActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class ParallelGripperCommandActionGetResultRequestMessage
        implements Action2GetResultRequestMessage {

    static final String NAME = "control_msgs/ParallelGripperCommandActionGetResult";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    @Override
    public ParallelGripperCommandActionGetResultRequestMessage withGoalId(
            Action2GoalIdMessage goal_id) {
