...
@MessageMetadata(
        name = GripperCommandActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class GripperCommandActionGetResultRequestMessage implements Action2GetResultRequestMessage {

    static final String NAME = "control_msgs/GripperCommandActionGetResult";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    @Override
    public GripperCommandActionGetResultRequestMessage withGoalId(Action2GoalIdMessage goal_id) {
