...
/** Definition for control_msgs/action/JointTrajectory */
public class JointTrajectoryActionDefinition
        implements Action2Definition<JointTrajectoryGoalMessage, JointTrajectoryResultMessage> {

    @Override
    public MessageDescriptor<? extends Action2GoalMessage<JointTrajectoryGoalMessage>>
            getActionGoalMessage() {
        return new MessageDescriptor<>(JointTrajectoryActionGoalMessage.class);
    }

    @Override
    public MessageDescriptor<? extends Action2ResultMessage<JointTrajectoryResultMessage>>
            getActionResultMessage() {
        return new MessageDescriptor<>(JointTrajectoryActionResultMessage.class);
    }

    @Override
    public MessageDescriptor<? extends Action2GetResultRequestMessage>
            getActionResultRequestMessage() {
        return new MessageDescriptor<>(JointTrajectoryActionGetResultRequestMessage.class);
    }
}
