...
@MessageMetadata(
        name = SingleJointPositionActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class SingleJointPositionActionGetResultRequestMessage
        implements Action2GetResultRequestMessage {

    static final String NAME = "control_msgs/SingleJointPositionActionGetResult";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    @Override
    public SingleJointPositionActionGetResultRequestMessage withGoalId(
