...
@MessageMetadata(
        name = PointHeadActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class PointHeadActionGetResultRequestMessage implements Action2GetResultRequestMessage {

    static final String NAME = "control_msgs/PointHeadActionGetResult";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    @Override
    public PointHeadActionGetResultRequestMessage withGoalId(Action2GoalIdMessage goal_id) {
