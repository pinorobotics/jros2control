...
@MessageMetadata(
        name = JointTrajectoryActionGoalMessage.NAME,
        fields = {"goal_id", "goal"},
        interfaceType = RosInterfaceType.ACTION)
public class JointTrajectoryActionGoalMessage
        implements Action2GoalMessage<JointTrajectoryGoalMessage> {

    static final String NAME = "control_msgs/JointTrajectoryActionGoal";

    public Action2GoalIdMessage goal_id = new Action2GoalIdMessage();

    public JointTrajectoryGoalMessage goal = new JointTrajectoryGoalMessage();

    @Override
    public JointTrajectoryActionGoalMessage withGoalId(Action2GoalIdMessage goal_id) {
        this.goal_id = goal_id;
        return this;
    }

    @Override
    public JointTrajectoryActionGoalMessage withGoal(JointTrajectoryGoalMessage goal) {
        this.goal = goal;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof JointTrajectoryActionGoalMessage other)
    ...
    @Override
    public JointTrajectoryGoalMessage getGoal() {
        return goal;
    }
