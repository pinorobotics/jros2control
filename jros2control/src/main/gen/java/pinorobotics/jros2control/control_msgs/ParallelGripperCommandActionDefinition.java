...
/** Definition for control_msgs/action/ParallelGripperCommand */
public class ParallelGripperCommandActionDefinition
        implements Action2Definition<
                ParallelGripperCommandGoalMessage, ParallelGripperCommandResultMessage> {

    @Override
    public MessageDescriptor<? extends Action2GoalMessage<ParallelGripperCommandGoalMessage>>
            getActionGoalMessage() {
        return new MessageDescriptor<>(ParallelGripperCommandActionGoalMessage.class);
    }

    @Override
    public MessageDescriptor<? extends Action2ResultMessage<ParallelGripperCommandResultMessage>>
            getActionResultMessage() {
        return new MessageDescriptor<>(ParallelGripperCommandActionResultMessage.class);
    }

    @Override
    public MessageDescriptor<? extends Action2GetResultRequestMessage>
            getActionResultRequestMessage() {
        return new MessageDescriptor<>(ParallelGripperCommandActionGetResultRequestMessage.class);
    }
}
